...
def _parse_config(raw_cfg: RawConfig) -> Config:
    ...
    try:
        ...
        # this was the behaviour of the old pkg_resources.parse_version
        # returning a LegacyVersion object, that when stringified equalled the
        # input.
        pep440_version = current_version
